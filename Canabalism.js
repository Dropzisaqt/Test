      ...
      function processCode(code) {
        ...
        setTimeout(function() {
          ...
          if(settings.burger || settings.cactus || settings.hotdog || settings.egg || settings.lime || settings.red_pepper) {
            let burg = new Image();
            burg.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';
            burg.width = burg.height = 47;
            burg.className = 'DqMRee SsAred';
                        
            let cact = new Image();
            cact.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';
            cact.width = cact.height = 47;
            cact.className = 'DqMRee SsAred';

            let dog = new Image();
            dog.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';
            dog.width = dog.height = 47;
            dog.className = 'DqMRee SsAred';

            let egg = new Image();
            egg.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';
            egg.width = egg.height = 47;
            egg.className = 'DqMRee SsAred';

            let lime = new Image();
            lime.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';
            lime.width = lime.height = 47;
            lime.className = 'DqMRee SsAred';

            let pepper = new Image();
            pepper.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';
            ...
            eval(`var bu_ = new Image(); bu_.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';`);
            eval(`var ca_ = new Image(); ca_.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';`);
            eval(`var do_ = new Image(); do_.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';`);
            eval(`var eg_ = new Image(); eg_.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';`);
            eval(`var li_ = new Image(); li_.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';`);
            eval(`var pe_ = new Image(); pe_.src = 'https://i.postimg.cc/L4T4YHgq/unnamed-64x64.png';`);
            eval(
              code.match(
